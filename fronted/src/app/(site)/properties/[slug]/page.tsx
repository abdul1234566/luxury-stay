...
export default function Details() {
  ...
  useEffect(() => {
    if (feedback.length > 1) {
      const i = setInterval(() => {
        setCurrentReviewIndex(p => p === feedback.length - 1 ? 0 : p + 1);
      }, 4000);
  ...
  const renderStars = (rating: number) => (
    <div className="flex gap-1">
      {[1,2,3,4,5].map(s => (
        <span key={s} className={s <= rating ? "text-[#A78256] dark:text-[#FFD700]" : "text-[#CBB292]/50"}>
          ★
        </span>
      ))}
    </div>
  ...
  return (
    <section className="pt-44 pb-24 bg-[#F5F0E1] dark:bg-[#1E1B18] text-[#3B2F2F] dark:text-[#F2E9E1]">
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-end mb-12">
          <div>
            ...
            <div className="flex items-center gap-2 text-[rgba(59,47,47,0.6)] dark:text-[rgba(242,233,225,0.6)]">
          ...
          <div className="flex justify-start md:justify-end gap-8">
            <div className="text-center">
              <Icon icon="solar:bed-linear" />
              <p>{item?.beds} Beds</p>
            </div>
            <div className="text-center">
              <Icon icon="solar:bath-linear" />
              <p>{item?.baths} Baths</p>
            </div>
            <div className="text-center">
              <Icon icon="lineicons:arrow-all-direction" />
              <p>{item?.area} m²</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {item?.images?.map((img, i) => (
            <Image
              ...
              width={500}
              height={400}
              className="rounded-2xl w-full h-[280px] object-cover shadow-xl"
              unoptimized
            />
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="bg-gradient-to-br from-[#F0E3D6] to-[#DCCAB0] dark:from-[#3A352F] dark:to-[#5B4E43] p-8 rounded-2xl shadow-2xl">
              <h3 className="text-2xl font-bold mb-4">Room Details</h3>
            ...
            {/* <iframe
              src="https://www.google.com/maps/embed?=!1m18!1m12!1m3!1d938779.7831767448!2d71.05098621661072!3d23.20271516446136!"
              className="w-full h-[380px] rounded-2xl shadow-xl"
              loading="lazy"
            /> */}
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d938779.7831767448!2d71.05098621661072!3d23.20271516446136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e82dd003ff749%3A0x359e803f537cea25!2sGANESH%20GLORY%2C%20Gota%2C%20Ahmedabad%2C%20Gujarat%20382481!5e0!3m2!1sen!2sin!4v1715676641521!5m2!1sen!2sin"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-[#F0E3D6] to-[#DCCAB0] dark:from-[#3A352F] dark:to-[#5B4E43] p-8 rounded-2xl shadow-2xl">
              ...
              <p className="opacity-70 mb-6">Per Night</p>

              <Link href={`/properties/book?room=${item?.slug}`}
                className="block text-center bg-[#A78256] dark:bg-[#FFD700] text-white dark:text-[#3B2F2F] py-3 rounded-full font-semibold hover:opacity-90 transition">
                Book Now
              </Link>
            </div>

            {/* REVIEWS */}
            <div className="bg-gradient-to-br from-[#F0E3D6] to-[#DCCAB0] dark:from-[#3A352F] dark:to-[#5B4E43] p-6 rounded-2xl shadow-2xl">
              <h4 className="font-bold mb-4">Guest Reviews</h4>
              ...
              {loadingFeedback ? (
                ...
                <p className="opacity-60 text-sm">No reviews yet</p>
              )}
            </div>
...
//         <div className="flex gap-1">
//             {[1,2,3,4,5].map((star) => (
//                 <span key={star} className={`text-lg ${star <= rating ? "text-[#FFD700]" : "text-[#2C2B28]/50 dark:text-[#F2E9E1]/50"}`}>★</span>
//             ))}
//         </div>
//     );
...
//     return (
//         <section className="!pt-44 pb-20 relative transition-colors bg-[#F5F0E1] dark:bg-[#1E1B18] text-[#3B2F2F] dark:text-[#F2E9E1]">
//             <div className="container mx-auto max-w-8xl px-5 2xl:px-0">
//                 <div className="grid grid-cols-12 items-end gap-6">
//                     <div className="lg:col-span-8 col-span-12">
//                         <h1 className='lg:text-52 text-40 font-semibold text-[#3B2F2F] dark:text-[#F2E9E1]'>{item?.name}</h1>
//                         <div className="flex gap-2.5">
//                             <Icon icon="ph:map-pin" width={24} height={24} className="text-[#3B2F2F]/50 dark:text-[#F2E9E1]/50" />
//                             <p className='text-[#3B2F2F]/50 dark:text-[#F2E9E1]/50 text-xm'>{item?.location}</p>
//                         </div>
//                     </div>
//                     <div className="lg:col-span-4 col-span-12">
//                         <div className='flex'>
//                             <div className='flex flex-col gap-2 border-e border-[#3B2F2F]/10 dark:border-[#F2E9E1]/20 pr-2 xs:pr-4 mobile:pr-8'>
//                                 <Icon icon={'solar:bed-linear'} width={20} height={20} className="text-[#3B2F2F] dark:text-[#F2E9E1]" />
//                                 <p className='text-sm mobile:text-base font-normal text-[#3B2F2F] dark:text-[#F2E9E1]'>{item?.beds} Bedrooms</p>
//                             </div>
//                             <div className='flex flex-col gap-2 border-e border-[#3B2F2F]/10 dark:border-[#F2E9E1]/20 px-2 xs:px-4 mobile:px-8'>
//                                 <Icon icon={'solar:bath-linear'} width={20} height={20} className="text-[#3B2F2F] dark:text-[#F2E9E1]" />
//                                 <p className='text-sm mobile:text-base font-normal text-[#3B2F2F] dark:text-[#F2E9E1]'>{item?.baths} Bathrooms</p>
//                             </div>
//                             <div className='flex flex-col gap-2 pl-2 xs:pl-4 mobile:pl-8'>
//                                 <Icon icon={'lineicons:arrow-all-direction'} width={20} height={20} className="text-[#3B2F2F] dark:text-[#F2E9E1]" />
//                                 <p className='text-sm mobile:text-base font-normal text-[#3B2F2F] dark:text-[#F2E9E1]'>{item?.area}m<sup>2</sup></p>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
...
//                     <div className="lg:col-span-8 col-span-12 row-span-2">
//                         {item?.images && item?.images[0] && (
//                             <Image src={item.images[0]?.src} alt="Main Property" width={400} height={500} className="rounded-2xl w-full h-540" unoptimized />
//                         )}
//                     </div>
//                     {item?.images?.slice(1,4).map((img, idx) => (
//                         <div key={idx} className={`lg:col-span-2 col-span-6`}>
//                             <Image src={img?.src} alt={`Property ${idx+2}`} width={400} height={500} className="rounded-2xl w-full h-full" unoptimized />
//                         </div>
//                     ))}
//                 </div>
...
//                 <div className="grid grid-cols-12 gap-8 mt-10">
//                     <div className="lg:col-span-8 col-span-12">
//                         <h3 className='text-xl font-medium text-[#3B2F2F] dark:text-[#F2E9E1]'>Property details</h3>
//                         <div className="py-8 my-8 border-y border-[#3B2F2F]/10 dark:border-[#F2E9E1]/20 flex flex-col gap-8">
//                             {[
//                                 { icon: '/images/SVGs/property-details.svg', iconDark: '/images/SVGs/property-details-white.svg', title:'Property details', desc:'One of the few homes in the area with a private pool.' },
//                                 { icon: '/images/SVGs/smart-home-access.svg', iconDark: '/images/SVGs/smart-home-access-white.svg', title:'Smart home access', desc:'Easily check yourself in with a modern keypad system.' },
//                                 { icon: '/images/SVGs/energyefficient.svg', iconDark: '/images/SVGs/energyefficient-white.svg', title:'Energy efficient', desc:'Built in 2025 with sustainable and smart-home features.' },
//                             ].map((item, idx) => (
//                                 <div key={idx} className="flex items-center gap-6">
//                                     <div>
//                                         <Image src={item.icon} width={400} height={500} alt="" className='w-8 h-8 dark:hidden' unoptimized />
//                                         <Image src={item.iconDark} width={400} height={500} alt="" className='w-8 h-8 dark:block hidden' unoptimized />
//                                     </div>
//                                     <div>
//                                         <h3 className='text-[#3B2F2F] dark:text-[#F2E9E1] text-xm'>{item.title}</h3>
//                                         <p className='text-[#3B2F2F]/50 dark:text-[#F2E9E1]/50'>{item.desc}</p>
//                                     </div>
//                                 </div>
//                             ))}
//                         </div>
...
//                         <div className="flex flex-col gap-5">
//                             <p className='text-[#3B2F2F] dark:text-[#F2E9E1] text-xm'>Nestled in the heart of Miami, the modern luxe villa...</p>
//                             <p className='text-[#3B2F2F] dark:text-[#F2E9E1] text-xm'>Step inside to discover an open-concept layout...</p>
//                             <p className='text-[#3B2F2F] dark:text-[#F2E9E1] text-xm'>The primary suite serves as a private retreat...</p>
//                             <p className='text-[#3B2F2F] dark:text-[#F2E9E1] text-xm'>Outdoor living is equally impressive...</p>
//                         </div>

//                         <div className="py-8 mt-8 border-t border-[#3B2F2F]/5 dark:border-[#F2E9E1]/15">
//                             <h3 className='text-xl font-medium text-[#3B2F2F] dark:text-[#F2E9E1]'>What this property offers</h3>
//                             <div className="grid grid-cols-3 mt-5 gap-6">
//                                 {[
//                                     { icon:'ph:aperture', text:'Smart Home Integration' },
//                                     { icon:'ph:chart-pie-slice', text:'Spacious Living Areas' },
//                                     { icon:'ph:television-simple', text:'Energy Efficiency' },
//                                     { icon:'ph:sun', text:'Natural Light' },
//                                     { icon:'ph:video-camera', text:'Security Systems' },
//                                     { icon:'ph:cloud', text:'Outdoor Spaces' },
//                                 ].map((item, idx) => (
//                                     <div key={idx} className="flex items-center gap-2.5">
//                                         <Icon icon={item.icon} width={24} height={24} className="text-[#3B2F2F] dark:text-[#F2E9E1]" />
//                                         <p className='text-[#3B2F2F] dark:text-[#F2E9E1]'>{item.text}</p>
//                                     </div>
//                                 ))}
//                             </div>
//                         </div>
...
//                     {/* Booking & Reviews */}
//                     <div className="lg:col-span-4 col-span-12">
//                         <div className="bg-[#DCCAB0]/10 dark:bg-[#5B4E43]/10 p-8 rounded-2xl relative z-10 overflow-hidden">
//                             <h4 className='text-[#3B2F2F] dark:text-[#F2E9E1] text-3xl font-medium'>
//                                 {systemSettings && item?.roomType 
//                                   ? formatCurrency(getCurrentRoomRate(item.roomType, systemSettings), systemSettings)
//                                   : `$${item?.rate}`}
//                             </h4>
//                             <p className='text-[#3B2F2F]/50 dark:text-[#F2E9E1]/50 text-sm'>Room Price per Day</p>
//                             <Link href={`/properties/book?room=${item?.slug}`} className='py-4 px-8 bg-[#A78256] text-[#FFF5E1] rounded-full w-full block text-center hover:opacity-90 duration-300 text-base mt-8 hover:cursor-pointer'>
//                                 Book Now
//                             </Link>
//                             <div className="absolute right-0 top-4 -z-[1]">
//                                 <Image src="/images/properties/vector.svg" width={400} height={500} alt="vector" unoptimized />
//                             </div>
//                         </div>
...
//                         <div className="mt-6">
//                             <div className="flex items-center justify-between mb-4">
//                                 <h4 className="font-semibold text-[#3B2F2F] dark:text-[#F2E9E1]">Guest Reviews</h4>
//                                 {totalReviews > 0 && (
//                                     <div className="flex items-center gap-2">
//                                         {renderStars(averageRating)}
//                                         <span className="text-sm text-[#2C2B28]/70 dark:text-[#F2E9E1]/70">{averageRating} ({totalReviews})</span>
//                                     </div>
//                                 )}
//                             </div>
...
//                             {loadingFeedback ? (
//                                 <div className="text-center py-6">
//                                     <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#A78256] mx-auto"></div>
//                                     <p className="text-[#2C2B28]/70 dark:text-[#F2E9E1]/70 mt-2 text-sm">Loading reviews...</p>
//                                 </div>
//                             ) : feedback.length > 0 ? (
//                                 <div className="relative">
//                                     <div className="bg-[#F0E3D6] dark:bg-[#3A352F] rounded-xl p-4 shadow-lg border border-[#3B2F2F]/10 dark:border-[#F2E9E1]/20">
//                                         {/* Single Review Card */}
//                                     </div>
//                                 </div>
//                             ) : (
//                                 <div className="text-center py-6 bg-[#F0E3D6]/50 dark:bg-[#3A352F]/30 rounded-xl border border-[#3B2F2F]/10 dark:border-[#F2E9E1]/20">
//                                     <Icon icon="ph:star" className="text-[#FFD700] text-3xl mx-auto mb-2" />
//                                     <h5 className="text-sm font-semibold text-[#3B2F2F] dark:text-[#F2E9E1] mb-1">No reviews yet</h5>
//                                     <p className="text-xs text-[#2C2B28]/70 dark:text-[#F2E9E1]/70 mb-3">Be the first to review!</p>
//                                     <button className="px-4 py-2 bg-[#A78256] text-[#FFF5E1] rounded-full hover:opacity-90 transition-opacity duration-300 text-sm">Write Review</button>
//                                 </div>
//                             )}
//                         </div>
//                     </div>
